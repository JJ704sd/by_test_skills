...
Request only the smallest missing item: safe environment access, a redacted trace, log, or core dump, or narrowly scoped instrumentation permission. Label conclusions from static analysis as unverified.
