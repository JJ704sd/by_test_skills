...
| Configuration change | Read old and new keys with precedence defined | Environment or config inventory and deprecation signal | Old key is absent from supported deployments |
